...
class Location extends BaseModel
{
    ...
    {
        $model = new static;
        return $model->where('u_network_mob_dateISNOTEMPTY')->where('u_network_demob_dateISEMPTY')->get();
    }

    public static function allPremobe()
    {
        $model = new static;
        return $model->where('u_network_mob_dateISEMPTY')->where('u_network_demob_dateISEMPTY')->get();
    }

    public static function allPremobeAndActive()
    {
        $model = new static;
        return $model->where('u_network_demob_dateISEMPTY')->get();
    }
